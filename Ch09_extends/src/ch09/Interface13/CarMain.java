...
import ch09.Interface13.factroy01.FordCar;
import ch09.Interface13.factroy01.HyundaiCar;
import ch09.Interface13.factroy01.ToyotaCar;
import ch09.Interface13.order01.CarTester;

/*
[시나리오]
1. bitcamp는 자동차 산업을 진출하기 위해 자동차를 OEM 생산주문 하기로 결정했다.
자동차의 Specitication를 각 자동차 제조사에 제공하기 위해
...
2.A 자동차 제조사
	...
	구현 클래스가 완성되면 Bitcamp에 보내서 테스를 진행할 예정이다.
