...
import ch09.Reslove14.question01.InkJetPrinter;
import ch09.Reslove14.question01.LaserPrinter;
import ch09.Reslove14.question01.P_INTERFACE;
...
public class Answer1 implements IQuestionAnswer {
	...
	public void answer(Scanner sc) {
		...
		LaserPrinter lp = 
				new LaserPrinter("Samsung-264", "Samsung", 
						P_INTERFACE.PARALLER_PORT, 20, 100 , 100);
		ijp.print();
		ijp.print();
		ijp.print();
